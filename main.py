...
def get_results():
    ...
    message = f"<p>Smallest number: {smallest_number}. Generated by instance ID: {smallest_instance}.</p><br><p>Largest number: {largest_number}. Generated by instance ID: {largest_instance}</p>"

    return table + "<br><br>" + message
